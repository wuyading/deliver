jQuery(function() {
    ...
    function addFile( file ) {
        var $li = $( '<li id="' + file.id + '">' +
            ...
            '<p class="imgWrap"></p>'+
            '<input type="hidden" class="gallery" name="gallery[]" value="">'+
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'confirm':
                ...
                break;
            case 'finish':
                console.log(uploader.getResponse);
    ...
    uploader.on( 'all', function( type,file,response ) {
        ...
        switch( type ) {
            ...
            case 'uploadSuccess':
                $( '#'+file.id ).find('.gallery').val(response.img);
                break;
        }
    });
...
jQuery(function() {
    ...
    uploader.on( 'fileQueued', function( file ) {
        var $li = $(
            ...
            '<input type="hidden" class="img_path" name="goods_image" value="">' +
