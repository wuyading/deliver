...
@section('body')
    <body class=" login">
        ...
        <div class="intro">
            ...
            <!-- BEGIN LOGO -->
            <div class="logo">
                <a href="#"><?=asset_img('assets/pages/img/logo-big.png')?></a>
            </div>
            <!-- END LOGO -->
            <!-- BEGIN LOGIN -->
            <div class="content">
                ...
                <form class="login-form" action="<?=toRoute('login/login_in')?>" method="post">
                    <h3 class="form-title font-green">后台登录系统</h3>
        ...
        <?=asset_js('assets/global/plugins/jsencrypt/jsencrypt.min.js')?>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <?=asset_js('assets/pages/scripts/login_rsa.min.js')?>
