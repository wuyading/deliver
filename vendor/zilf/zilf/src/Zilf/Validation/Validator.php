...
class Validator
{
     ...
     *
     * @var \Zilf\Validation\TranslatorInterface
     */
     ...
     *
     * @var \Zilf\Validation\PresenceVerifierInterface
     */
     ...
     * The messages.
     *
     * @var \Zilf\Validation\MessageBag
     */
    protected $messages;
    ...
    public function after($callback)
    {
        $this->after[] = function () use ($callback) {
            return call_user_func($callback, [], 'validate');
        };
    ...
    {
        if ($extensions) {
            $keys = array_map('Zilf\Validation\snake_case', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('Zilf\Validation\snake_case', array_keys($replacers));
     ...
     *
     * @param \Zilf\Validation\PresenceVerifierInterface $presenceVerifier
     */
