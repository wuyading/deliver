...
abstract class IteratorTestCase extends TestCase
{
     ...
     *                               $a and $b such that $a goes before $b in
     *                               $expected, the method asserts that any
     *                               element of $a goes before any element of $b
    ...
    protected function assertIteratorInForeach($expected, \Traversable $iterator)
    {
        ...
        foreach ($iterator as $file) {
            $this->assertInstanceOf('Zilf\\\Finder\\SplFileInfo', $file);
