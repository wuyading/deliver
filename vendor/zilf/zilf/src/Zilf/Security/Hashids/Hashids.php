...
class Hashids implements HashidsInterface
{
     ...
     * @return void
     */
    public function __construct($salt = '', $minHashLength = 6, $alphabet = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890')
    {
        if (empty($salt)) {
            $salt = config_helper('app_key') ? config_helper('app_key') : '';
        }
