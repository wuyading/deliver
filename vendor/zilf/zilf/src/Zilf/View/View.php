...
use Zilf\View\Engines\EngineInterface;
use Illuminate\Contracts\Support\MessageProvider;
use Zilf\View\Contracts\View as ViewContract;
...
class View implements ArrayAccess, ViewContract
{
     ...
     *
     * @var \Zilf\View\Engines\EngineInterface
     */
    protected $engine;
     ...
     *
     * @param  \Zilf\View\Factory                 $factory
     * @param  \Zilf\View\Engines\EngineInterface $engine
     * @param  string                             $view
     * @param  string                             $path
     * @param  mixed                              $data
     * @return void
