...
interface ActiveRecordInterface
{
     ...
     *                           Please refer to [[QueryInterface::where()]] on how to specify
     ...
     *                               before saving the record. Defaults to `true`. If the validation fails,
     *                               the record will not be saved to the database and this method will return
     *                               `false`.
     ...
     *                       saved. If true, the model containing the foreign key will
     *                       be deleted.
     */
