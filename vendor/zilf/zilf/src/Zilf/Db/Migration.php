...
class Migration extends Component implements MigrationInterface
{
     ...
     *                       into the physical one. Anything that is not recognized as abstract type will be kept in the generated SQL. For
     *                       example, 'string' will be turned into 'varchar(255)', while 'string not null' will become 'varchar(255) not null'.
     */
     ...
     *                       into the physical one. Anything that is not recognized as abstract type will be kept in the generated SQL. For example,
     *                       'string' will be turned into 'varchar(255)', while 'string not null' will become 'varchar(255) not null'.
     */
