 ...
 *
 * ```php
 * $connection = new \Zilf\Db\Connection([
 *     'dsn' => $dsn,
 *     'username' => $username,
 *     'password' => $password,
 * ]);
...
class Connection extends Component
{
    ...
    public $schemaMap = [
        ...
        'mysqli' => 'Zilf\Db\mysql\Schema', // MySQL
        'mysql' => 'Zilf\Db\mysql\Schema', // MySQL
        'sqlite' => 'Zilf\Db\sqlite\Schema', // sqlite 3
        'sqlite2' => 'Zilf\Db\sqlite\Schema', // sqlite 2
        'sqlsrv' => 'Zilf\Db\mssql\Schema', // newer MSSQL driver on MS Windows hosts
        'oci' => 'Zilf\Db\oci\Schema', // Oracle driver
        'mssql' => 'Zilf\Db\mssql\Schema', // older MSSQL driver on MS Windows hosts
        'dblib' => 'Zilf\Db\mssql\Schema', // dblib drivers on GNU/Linux (and maybe other OSes) hosts
