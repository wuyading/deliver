...
namespace Zilf\HttpFoundation\Tests\Session\Flash;

use Zilf\HttpFoundation\Session\Flash\AutoExpireFlashBag as FlashBag;
...
{
    /**
     * @var \Zilf\HttpFoundation\Session\Flash\AutoExpireFlashBag
     */
    private $bag;
