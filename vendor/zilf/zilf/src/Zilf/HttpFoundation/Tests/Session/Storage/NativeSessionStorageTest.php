...
namespace Zilf\HttpFoundation\Tests\Session\Storage;

use Zilf\HttpFoundation\Session\Attribute\AttributeBag;
use Zilf\HttpFoundation\Session\Flash\FlashBag;
use Zilf\HttpFoundation\Session\Storage\Handler\NativeSessionHandler;
use Zilf\HttpFoundation\Session\Storage\Handler\NullSessionHandler;
use Zilf\HttpFoundation\Session\Storage\NativeSessionStorage;
use Zilf\HttpFoundation\Session\Storage\Proxy\SessionHandlerProxy;
...
class NativeSessionStorageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetSaveHandler()
    {
        ...
        $this->assertInstanceOf('Zilf\HttpFoundation\Session\Storage\Proxy\SessionHandlerProxy', $storage->getSaveHandler());
