...
namespace Zilf\HttpFoundation\Tests\File\MimeType;

use Zilf\HttpFoundation\File\MimeType\MimeTypeGuesser;
use Zilf\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser;
...
class MimeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuessWithNonReadablePath()
    {
        ...
        if (substr(sprintf('%o', fileperms($path)), -4) == '0333') {
            $this->setExpectedException('Zilf\HttpFoundation\File\Exception\AccessDeniedException');
